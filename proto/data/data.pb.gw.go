...
func request_DataService_SetData_0(ctx context.Context, marshaler runtime.Marshaler, client DataServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterDataServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DataServiceClient) error {
	...
	mux.Handle("POST", pattern_DataService_SetData_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_DataService_SetData_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_DataService_SetData_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_DataService_SetData_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"v2", "g", "1", "t", "name", "data"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_DataService_SetData_0 = runtime.ForwardResponseMessage
)
