...
// Validate checks the field values on ResourceTenancy with the rules defined
// in the proto definition for this message. If any rules are violated, the
...
// ValidateAll checks the field values on ResourceTenancy with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ResourceTenancyMultiError, or nil if none found.
func (m *ResourceTenancy) ValidateAll() error {
	return m.validate(true)
}

func (m *ResourceTenancy) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ResourceTenancyMultiError(errors)
	}

	return nil
}

// ResourceTenancyMultiError is an error wrapping multiple validation errors
// returned by ResourceTenancy.ValidateAll() if the designated constraints
// aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m ResourceTenancyMultiError) AllErrors() []error { return m }

// ResourceTenancyValidationError is the validation error returned by
// ResourceTenancy.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e ResourceTenancyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ResourceTenancyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ResourceTenancyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ResourceTenancyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ResourceTenancyValidationError) ErrorName() string { return "ResourceTenancyValidationError" }
...
func (e ResourceTenancyValidationError) Error() string {
	...
	return fmt.Sprintf(
		"invalid %sResourceTenancy.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ResourceTenancyValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ResourceTenancyValidationError{}
...
func (m *ResourceID) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetTenancy()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, ResourceIDValidationError{
					field:  "Tenancy",
	...
	} else if v, ok := interface{}(m.GetTenancy()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return ResourceIDValidationError{
				field:  "Tenancy",
				reason: "embedded message failed validation",
